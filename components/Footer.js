        ...
        <>
            <footer className="text-center bg-gray-500 dark:bg-gray-900 text-white mt-10">
                ...
                <div className="text-center p-4 bg-black/20" >
                    Copyright © {new Date().getFullYear()} <Link className="text-whitehite" href={process.env.NEXT_PUBLIC_SITE} alt={process.env.NEXT_PUBLIC_SITE_TITLE}>{process.env.NEXT_PUBLIC_SITE_TITLE}</Link> - All right reserved.
                </div>
            </footer>
            {/*<Totop/>*/}
        </>
